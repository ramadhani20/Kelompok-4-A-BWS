...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TATA LAUNDRY");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("Jalan KH. Asyari, Blok Timur, Kademangan, Bondowoso Regency, East Java");
    ...
    private void tentangMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tentangMousePressed
        JOptionPane.showMessageDialog(this,
           "-Amalia Siska Kurniawati\n"
                   + "-Azizatun Hasanah\n"
                   + "-M Rizky R\n"
                   + "-Dimas Mulya Perkasa Ernanta\n"
                   + "-Gita Fadia Setyorini",
           "Anggota Kelompok",
