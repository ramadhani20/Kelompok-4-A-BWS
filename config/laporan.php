...
<html>
<head>
	<title>LAPORAN Tata Laundry </title>
</head>
<body>
	<form method="post">
		<table align="center">
			<tr>
				<td>
					<div class="mainutama">
						<table align="center">
							<tr>
       						...
       						<td width="93%" valign="bottom">&nbsp;LAPORAN TATA LAUNDRY</td>
							</tr>
							<tr>
								<td colspan="2">Jalan KH. Asyari, Blok Timur, Kademangan, Bondowoso Regency, East Java</td>
							</tr>
						</table>
						<table width="100%">
						<tr><td><hr></td></tr>
			    	...
			    	<table align="center">
			      		<tr>
			        	<td>&copy; <?php echo date('Y'); ?> TIF A BWS</td>
			      		</tr>
			    	</table>
					</div>
				</td>
